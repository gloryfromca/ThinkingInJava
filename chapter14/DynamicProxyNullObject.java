...
public class DynamicProxyNullObject {
	...
	public static void main(String[] args) {
		Robot cleanNullRobot = (Robot) Proxy.newProxyInstance(DynamicProxy.class.getClassLoader(),
				new Class[] { Null.class, Robot.class }, new NullObjectProxyHandler(CleanRobot.class));
		cleanNullRobot.name();
